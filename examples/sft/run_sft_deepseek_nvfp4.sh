...
export MEGATRON_CHUNKED_LM_HEAD_LOSS="${MEGATRON_CHUNKED_LM_HEAD_LOSS:-1}"
...
STREAMBP_MOE_MLP_BACKWARD_CHUNKS="${STREAMBP_MOE_MLP_BACKWARD_CHUNKS:-4}"
export MEGATRON_STREAMBP_SPLIT_MOE_MLP_ATTENTION_BACKWARD="${MEGATRON_STREAMBP_SPLIT_MOE_MLP_ATTENTION_BACKWARD:-1}"
MEGATRON_STREAMBP_MOE_ATTENTION_BACKWARD_CHUNK_SIZE="${MEGATRON_STREAMBP_MOE_ATTENTION_BACKWARD_CHUNK_SIZE:-}"
MOE_ROUTER_PADDING_FOR_QUANTIZATION="${MOE_ROUTER_PADDING_FOR_QUANTIZATION:-1}"
MOE_TOKEN_DISPATCHER_TYPE="${MOE_TOKEN_DISPATCHER_TYPE:-flex}"
MOE_FLEX_DISPATCHER_BACKEND="${MOE_FLEX_DISPATCHER_BACKEND:-deepep}"
export MEGATRON_STREAMBP_REPLAY_SAVE_QUANTIZED_TE_INPUTS="${MEGATRON_STREAMBP_REPLAY_SAVE_QUANTIZED_TE_INPUTS:-1}"
export MEGATRON_STREAMBP_RELEASE_MLP_INPUT_BEFORE_BACKWARD="${MEGATRON_STREAMBP_RELEASE_MLP_INPUT_BEFORE_BACKWARD:-1}"
export MEGATRON_STREAMBP_HOST_SAVE_HIDDEN="${MEGATRON_STREAMBP_HOST_SAVE_HIDDEN:-1}"
...
export MEGATRON_TE_RETAIN_TENSOR_OBJECTS_FOR_REENTRANT_BACKWARD="${MEGATRON_TE_RETAIN_TENSOR_OBJECTS_FOR_REENTRANT_BACKWARD:-1}"
...
# surface. The current 16 GPU shape showed no material memory or time win, while it
# obscured the real MoE/StreamBP bottleneck.
...
export MEGATRON_MOE_EXPERT_FC1_TRIM_CACHE="${MEGATRON_MOE_EXPERT_FC1_TRIM_CACHE:-1}"
...
export MEGATRON_MOE_SORT_TRIM_CACHE="${MEGATRON_MOE_SORT_TRIM_CACHE:-1}"
...
export MEGATRON_DSA_BACKWARD_TRIM_CACHE="${MEGATRON_DSA_BACKWARD_TRIM_CACHE:-1}"
...
export MEGATRON_DSA_SPLIT_QK_REENTRANT_KV_BWD="${MEGATRON_DSA_SPLIT_QK_REENTRANT_KV_BWD:-1}"
export MEGATRON_DSA_SPLIT_QK_REENTRANT_KV_BWD_CHUNK="${MEGATRON_DSA_SPLIT_QK_REENTRANT_KV_BWD_CHUNK:-8192}"
export MEGATRON_DSA_SPLIT_QK_REENTRANT_DEFER_QUERY_GRADS="${MEGATRON_DSA_SPLIT_QK_REENTRANT_DEFER_QUERY_GRADS:-1}"
...
export MEGATRON_HISA_CANDIDATE_MAX_TEMP_MB="${MEGATRON_HISA_CANDIDATE_MAX_TEMP_MB:-32}"
export MEGATRON_HISA_CANDIDATE_FREE_MEM_RESERVE_MB="${MEGATRON_HISA_CANDIDATE_FREE_MEM_RESERVE_MB:-64}"
export MEGATRON_HISA_COMPACT_CANDIDATE_TOPK="${MEGATRON_HISA_COMPACT_CANDIDATE_TOPK:-1}"
export MEGATRON_HISA_SELECTOR_BACKEND="${MEGATRON_HISA_SELECTOR_BACKEND:-deepgemm}"
...
export MEGATRON_DSA_TEACHER_SCORE_SCRATCH="${MEGATRON_DSA_TEACHER_SCORE_SCRATCH:-0}"
