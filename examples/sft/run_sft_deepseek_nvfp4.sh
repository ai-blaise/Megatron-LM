...
STREAMBP_CHUNK_SIZE="${STREAMBP_CHUNK_SIZE:-4096}"
...
STREAMBP_MOE_MLP_BACKWARD_CHUNKS="${STREAMBP_MOE_MLP_BACKWARD_CHUNKS:-16}"
...
export MEGATRON_HISA_CANDIDATE_MAX_TEMP_MB="${MEGATRON_HISA_CANDIDATE_MAX_TEMP_MB:-128}"
