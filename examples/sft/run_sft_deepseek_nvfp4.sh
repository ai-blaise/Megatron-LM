...
export MEGATRON_TEMP_ACTIVATION_OFFLOAD="${MEGATRON_TEMP_ACTIVATION_OFFLOAD:-1}"
export MEGATRON_TEMP_ACTIVATION_OFFLOAD_MODULES="${MEGATRON_TEMP_ACTIVATION_OFFLOAD_MODULES:-mlp_residual moe_shared}"
export MEGATRON_TEMP_ACTIVATION_OFFLOAD_MIN_MB="${MEGATRON_TEMP_ACTIVATION_OFFLOAD_MIN_MB:-16}"
export MEGATRON_TEMP_ACTIVATION_OFFLOAD_EMPTY_CACHE="${MEGATRON_TEMP_ACTIVATION_OFFLOAD_EMPTY_CACHE:-1}"
export MEGATRON_TEMP_ACTIVATION_OFFLOAD_NON_BLOCKING="${MEGATRON_TEMP_ACTIVATION_OFFLOAD_NON_BLOCKING:-0}"
...
export MEGATRON_MOE_EXPERT_FC1_TRIM_FREE_MB="${MEGATRON_MOE_EXPERT_FC1_TRIM_FREE_MB:-65536}"
export MEGATRON_MOE_EXPERT_FC1_TRIM_RESERVE_MB="${MEGATRON_MOE_EXPERT_FC1_TRIM_RESERVE_MB:-2048}"
export MEGATRON_MOE_EXPERT_FC1_TRIM_CACHED_MB="${MEGATRON_MOE_EXPERT_FC1_TRIM_CACHED_MB:-256}"
export MEGATRON_MOE_EXPERT_FC1_TRIM_SYNC="${MEGATRON_MOE_EXPERT_FC1_TRIM_SYNC:-1}"
export MEGATRON_MOE_EXPERT_FC1_TRIM_GC="${MEGATRON_MOE_EXPERT_FC1_TRIM_GC:-1}"
...
export MEGATRON_MOE_EXPERT_FC2_TRIM_SYNC="${MEGATRON_MOE_EXPERT_FC2_TRIM_SYNC:-1}"
export MEGATRON_MOE_SORT_TRIM_CACHE="${MEGATRON_MOE_SORT_TRIM_CACHE:-1}"
export MEGATRON_MOE_SORT_TRIM_FREE_MB="${MEGATRON_MOE_SORT_TRIM_FREE_MB:-65536}"
export MEGATRON_MOE_SORT_TRIM_SAFETY_MB="${MEGATRON_MOE_SORT_TRIM_SAFETY_MB:-1024}"
export MEGATRON_MOE_SORT_TRIM_CACHED_MB="${MEGATRON_MOE_SORT_TRIM_CACHED_MB:-512}"
export MEGATRON_MOE_SORT_TRIM_SYNC="${MEGATRON_MOE_SORT_TRIM_SYNC:-1}"
...
export MEGATRON_DSA_BACKWARD_TRIM_CACHED_MB="${MEGATRON_DSA_BACKWARD_TRIM_CACHED_MB:-512}"
export MEGATRON_DSA_BACKWARD_TRIM_SYNC="${MEGATRON_DSA_BACKWARD_TRIM_SYNC:-1}"
...
OFFLOAD_ARGS=()
if [[ "${FINE_GRAINED_ACTIVATION_OFFLOADING:-1}" == "1" ]]; then
    OFFLOAD_MODULES_VALUE="${OFFLOAD_MODULES:-expert_fc1 core_attn attn_proj qkv_linear moe_act attn_norm mlp_norm mlp_residual moe_shared}"
    # shellcheck disable=SC2206
