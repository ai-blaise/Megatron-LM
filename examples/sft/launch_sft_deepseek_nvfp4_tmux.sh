...
MoE replay trim: enabled=${MEGATRON_STREAMBP_MOE_REPLAY_TRIM_CACHE:-1} free_mb=${MEGATRON_STREAMBP_MOE_REPLAY_TRIM_FREE_MB:-65536} cached_mb=${MEGATRON_STREAMBP_MOE_REPLAY_TRIM_CACHED_MB:-0} sync=${MEGATRON_STREAMBP_MOE_REPLAY_TRIM_SYNC:-1}
...
MoE unpadding trim: enabled=${MEGATRON_MOE_UNPADDING_TRIM_CACHE:-1} free_mb=${MEGATRON_MOE_UNPADDING_TRIM_FREE_MB:-65536} cached_mb=${MEGATRON_MOE_UNPADDING_TRIM_CACHED_MB:-0}
MoE fc1 trim: enabled=${MEGATRON_MOE_EXPERT_FC1_TRIM_CACHE:-1} free_mb=${MEGATRON_MOE_EXPERT_FC1_TRIM_FREE_MB:-65536} reserve_mb=${MEGATRON_MOE_EXPERT_FC1_TRIM_RESERVE_MB:-2048} cached_mb=${MEGATRON_MOE_EXPERT_FC1_TRIM_CACHED_MB:-256} sync=${MEGATRON_MOE_EXPERT_FC1_TRIM_SYNC:-1} gc=${MEGATRON_MOE_EXPERT_FC1_TRIM_GC:-1}
MoE fc2 trim: enabled=${MEGATRON_MOE_EXPERT_FC2_TRIM_CACHE:-1} free_mb=${MEGATRON_MOE_EXPERT_FC2_TRIM_FREE_MB:-8192} cached_mb=${MEGATRON_MOE_EXPERT_FC2_TRIM_CACHED_MB:-256} sync=${MEGATRON_MOE_EXPERT_FC2_TRIM_SYNC:-1}
MoE sort trim: enabled=${MEGATRON_MOE_SORT_TRIM_CACHE:-1} free_mb=${MEGATRON_MOE_SORT_TRIM_FREE_MB:-65536} safety_mb=${MEGATRON_MOE_SORT_TRIM_SAFETY_MB:-1024} cached_mb=${MEGATRON_MOE_SORT_TRIM_CACHED_MB:-512} sync=${MEGATRON_MOE_SORT_TRIM_SYNC:-1}
...
Activation offload: enabled=${FINE_GRAINED_ACTIVATION_OFFLOADING:-1} modules="${OFFLOAD_MODULES:-expert_fc1 core_attn attn_proj qkv_linear moe_act attn_norm mlp_norm mlp_residual moe_shared}"
Temp offload:  enabled=${MEGATRON_TEMP_ACTIVATION_OFFLOAD:-1} modules="${MEGATRON_TEMP_ACTIVATION_OFFLOAD_MODULES:-mlp_residual moe_shared}" min_mb=${MEGATRON_TEMP_ACTIVATION_OFFLOAD_MIN_MB:-16} empty_cache=${MEGATRON_TEMP_ACTIVATION_OFFLOAD_EMPTY_CACHE:-1}
...
export MEGATRON_STREAMBP_MOE_REPLAY_TRIM_SYNC="${MEGATRON_STREAMBP_MOE_REPLAY_TRIM_SYNC:-1}"
...
export FINE_GRAINED_ACTIVATION_OFFLOADING="${FINE_GRAINED_ACTIVATION_OFFLOADING:-1}"
export OFFLOAD_MODULES="${OFFLOAD_MODULES:-expert_fc1 core_attn attn_proj qkv_linear moe_act attn_norm mlp_norm mlp_residual moe_shared}"
