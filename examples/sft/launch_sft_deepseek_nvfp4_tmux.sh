...
DSA fused:     triton=${MEGATRON_DSA_TRITON:-1} triton_indexer=${MEGATRON_DSA_TRITON_INDEXER:-1} streaming_topk=${MEGATRON_DSA_STREAMING_INDEXER_TOPK:-1} hisa_slot_group=${MEGATRON_HISA_CANDIDATE_SLOT_GROUP:-8} hisa_selector_cuda=${MEGATRON_HISA_SELECTOR_CUDA:-1} hisa_selector_row_chunk=${MEGATRON_HISA_SELECTOR_ROW_CHUNK:-256} hisa_fused_loss=${MEGATRON_HISA_FUSED_INDEXER_LOSS:-1} hisa_target_triton=${MEGATRON_HISA_TARGET_TRITON:-1} hisa_target_block_k=${MEGATRON_HISA_TARGET_BLOCK_K:-64} bwd_warps=${MEGATRON_DSA_TRITON_BWD_NUM_WARPS:-2}
...
export MEGATRON_HISA_SELECTOR_ROW_CHUNK="${MEGATRON_HISA_SELECTOR_ROW_CHUNK:-256}"
