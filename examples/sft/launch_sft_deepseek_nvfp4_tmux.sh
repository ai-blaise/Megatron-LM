...
Layer StreamBP: USE_STREAMBP=${USE_STREAMBP:-1} local_seq=$STREAMBP_LOCAL_SEQ_LENGTH chunk=$STREAMBP_CHUNK_SIZE
StreamBP LM:   fused_lce=${MEGATRON_STREAMBP_FUSED_LCE:-1} decoupled_lce=${MEGATRON_CHUNKED_LM_HEAD_LOSS:-1} logits_chunk=${STREAMBP_LOGITS_CHUNK_SIZE:-8192} lce_sp_tile=${MEGATRON_STREAMBP_FUSED_LCE_SP_TILE_SIZE:-1024} lce_fwd_split=${LCE_FWD_VOCAB_SPLIT_SIZE:-8192} lce_bwd_split=${LCE_BWD_VOCAB_SPLIT_SIZE:-8192}
StreamBP MoE:  chunk_forward=${STREAMBP_MOE_CHUNK_FORWARD:-0} mlp_chunks=${STREAMBP_MOE_MLP_CHUNKS:-1} bwd_mlp_chunks=${STREAMBP_MOE_MLP_BACKWARD_CHUNKS:-4} attn_bwd_chunk=${MEGATRON_STREAMBP_MOE_ATTENTION_BACKWARD_CHUNK_SIZE} split_mlp_attn_bwd=${MEGATRON_STREAMBP_SPLIT_MOE_MLP_ATTENTION_BACKWARD:-1} skip_pp=${MEGATRON_STREAMBP_SKIP_PP_RANKS-}
...
StreamBP hidden save: host=${MEGATRON_STREAMBP_HOST_SAVE_HIDDEN:-1} pin=${MEGATRON_STREAMBP_HOST_SAVE_PIN_MEMORY:-auto}
MoE replay trim: enabled=${MEGATRON_STREAMBP_MOE_REPLAY_TRIM_CACHE:-1} free_mb=${MEGATRON_STREAMBP_MOE_REPLAY_TRIM_FREE_MB:-16384} cached_mb=${MEGATRON_STREAMBP_MOE_REPLAY_TRIM_CACHED_MB:-2048} sync=${MEGATRON_STREAMBP_MOE_REPLAY_TRIM_SYNC:-0}
Replay TE save: quantized_inputs=${MEGATRON_STREAMBP_REPLAY_SAVE_QUANTIZED_TE_INPUTS:-1} release_mlp_input=${MEGATRON_STREAMBP_RELEASE_MLP_INPUT_BEFORE_BACKWARD:-1}
TE grouped:    fuse_wgrad_accum=${MEGATRON_TE_GROUPED_LINEAR_FUSE_WGRAD_ACCUM:-1} retain_reentrant_tensor_objects=${MEGATRON_TE_RETAIN_TENSOR_OBJECTS_FOR_REENTRANT_BACKWARD:-1}
MoE unpadding trim: enabled=${MEGATRON_MOE_UNPADDING_TRIM_CACHE:-1} free_mb=${MEGATRON_MOE_UNPADDING_TRIM_FREE_MB:-16384} cached_mb=${MEGATRON_MOE_UNPADDING_TRIM_CACHED_MB:-2048}
MoE fc1 trim: enabled=${MEGATRON_MOE_EXPERT_FC1_TRIM_CACHE:-1} free_mb=${MEGATRON_MOE_EXPERT_FC1_TRIM_FREE_MB:-16384} reserve_mb=${MEGATRON_MOE_EXPERT_FC1_TRIM_RESERVE_MB:-2048} cached_mb=${MEGATRON_MOE_EXPERT_FC1_TRIM_CACHED_MB:-2048} sync=${MEGATRON_MOE_EXPERT_FC1_TRIM_SYNC:-0} gc=${MEGATRON_MOE_EXPERT_FC1_TRIM_GC:-0}
MoE fc2 trim: enabled=${MEGATRON_MOE_EXPERT_FC2_TRIM_CACHE:-1} free_mb=${MEGATRON_MOE_EXPERT_FC2_TRIM_FREE_MB:-8192} cached_mb=${MEGATRON_MOE_EXPERT_FC2_TRIM_CACHED_MB:-2048} sync=${MEGATRON_MOE_EXPERT_FC2_TRIM_SYNC:-0}
MoE sort trim: enabled=${MEGATRON_MOE_SORT_TRIM_CACHE:-1} free_mb=${MEGATRON_MOE_SORT_TRIM_FREE_MB:-16384} safety_mb=${MEGATRON_MOE_SORT_TRIM_SAFETY_MB:-1024} cached_mb=${MEGATRON_MOE_SORT_TRIM_CACHED_MB:-2048} sync=${MEGATRON_MOE_SORT_TRIM_SYNC:-0}
MoE combine:  reduce_scatter_dtype=${MEGATRON_MOE_COMBINE_REDUCE_SCATTER_DTYPE:-input}
MLA key trim: enabled=${MEGATRON_MLA_TRIM_CACHE_BEFORE_KEY_CAT:-1} margin_mb=${MEGATRON_MLA_KEY_CAT_TRIM_MARGIN_MB:-1024} cached_mb=${MEGATRON_MLA_KEY_CAT_TRIM_CACHED_MB:-512}
...
DSA fused:     triton=${MEGATRON_DSA_TRITON:-1} triton_indexer=${MEGATRON_DSA_TRITON_INDEXER:-1} split_qk=${MEGATRON_DSA_SPLIT_QK:-1} streaming_topk=${MEGATRON_DSA_STREAMING_INDEXER_TOPK:-1} sort_topk=${MEGATRON_DSA_SORT_TOPK_INDICES:-0} compact_topk=${MEGATRON_DSA_COMPACT_TOPK_INDICES:-1} stream_triton_chunks=${MEGATRON_DSA_STREAM_TRITON_ATTENTION_CHUNKS:-1} validate_topk=${MEGATRON_DSA_VALIDATE_TOPK_INDICES:-0} hisa_slot_group=${MEGATRON_HISA_CANDIDATE_SLOT_GROUP:-16} hisa_temp_mb=${MEGATRON_HISA_CANDIDATE_MAX_TEMP_MB:-32} hisa_free_reserve_mb=${MEGATRON_HISA_CANDIDATE_FREE_MEM_RESERVE_MB:-64} hisa_compact_candidate=${MEGATRON_HISA_COMPACT_CANDIDATE_TOPK:-1} hisa_selector_backend=${MEGATRON_HISA_SELECTOR_BACKEND:-deepgemm} hisa_selector_cuda=${MEGATRON_HISA_SELECTOR_CUDA:-1} hisa_selector_row_chunk=${MEGATRON_HISA_SELECTOR_ROW_CHUNK:-512} hisa_bmm_tc=${MEGATRON_HISA_BMM_FP32_ACCUM_TENSORCORES:-0} hisa_bmm_cublasdx=${MEGATRON_HISA_BMM_CUBLASDX_REFINE:-1} hisa_assume_sorted=${MEGATRON_HISA_ASSUME_SORTED_POSITIONS:-1} hisa_dense_fallback=${MEGATRON_HISA_FALLBACK_DENSE_IF_SHORT:-0} hisa_fused_loss=${MEGATRON_HISA_FUSED_INDEXER_LOSS:-1} teacher_score_scratch=${MEGATRON_DSA_TEACHER_SCORE_SCRATCH:-0} bwd_score_scratch=${MEGATRON_DSA_TRITON_BWD_SCORE_SCRATCH:-1} dsa_bwd_trim=${MEGATRON_DSA_BACKWARD_TRIM_CACHE:-1} dsa_bwd_trim_sync=${MEGATRON_DSA_BACKWARD_TRIM_SYNC:-0} split_qk_reentrant_kv=${MEGATRON_DSA_SPLIT_QK_REENTRANT_KV_BWD:-1} split_qk_reentrant_chunk=${MEGATRON_DSA_SPLIT_QK_REENTRANT_KV_BWD_CHUNK:-8192} split_qk_pack_kv=${MEGATRON_DSA_SPLIT_QK_REENTRANT_PACK_KV_GRAD:-1} hisa_target_triton=${MEGATRON_HISA_TARGET_TRITON:-1} hisa_target_block_k=${MEGATRON_HISA_TARGET_BLOCK_K:-64} selected_bwd_head_group=${MEGATRON_HISA_SELECTED_SCORE_BWD_HEAD_GROUP:-8} selected_bwd_warp_grouped=${MEGATRON_HISA_SELECTED_SCORE_BWD_WARP_GROUPED:-1} bwd_block_k=${MEGATRON_DSA_TRITON_BLOCK_K_BWD:-32} bwd_warps=${MEGATRON_DSA_TRITON_BWD_NUM_WARPS:-2} cuda_split_qk_row=${MEGATRON_DSA_CUDA_SPLIT_QK_ROW_BWD:-1} cuda_split_qk_warps=${MEGATRON_DSA_CUDA_SPLIT_QK_ROW_BWD_WARPS:-8} cuda_kv_bwd=${MEGATRON_DSA_CUDA_KV_BWD:-0} cuda_kv_tile=${MEGATRON_DSA_CUDA_KV_BWD_TILE_Q:-2}x${MEGATRON_DSA_CUDA_KV_BWD_TILE_K:-4}
DSA top-k:     indexer=${DSA_INDEXER_TOPK:-512} indexcache_block=${DSA_INDEXCACHE_HISA_BLOCK_TOPK:-64} chunk=${DSA_CHUNK_SIZE}
DSA SP q trim: enabled=${MEGATRON_DSA_SP_Q_PROJ_TRIM_CACHE:-1} safety_mb=${MEGATRON_DSA_SP_Q_PROJ_TRIM_SAFETY_MB:-1024} cached_mb=${MEGATRON_DSA_SP_Q_PROJ_TRIM_CACHED_MB:-512} sync=${MEGATRON_DSA_SP_Q_PROJ_TRIM_SYNC:-1}
...
MoE local:     compact_deepep_permute=${MEGATRON_DEEPEP_COMPACT_LOCAL_PERMUTE:-1} compact_stable_map=${MEGATRON_DEEPEP_COMPACT_STABLE_MAP:-0} compact_row_chunk=${MEGATRON_DEEPEP_COMPACT_ROW_CHUNK:-131072} weighted_swiglu=${MEGATRON_WEIGHTED_SWIGLU_FUSER:-triton}
MoE LB type:   ${MOE_ROUTER_LOAD_BALANCING_TYPE:-seq_aux_loss}
MoE padding:   quantization=${MOE_ROUTER_PADDING_FOR_QUANTIZATION:-1}
MoE aux coeff: ${MOE_AUX_LOSS_COEFF:-1e-4}
MoE bias upd:  ${MOE_ROUTER_BIAS_UPDATE_RATE:-1e-3}
MoE bias rule: ${MOE_ROUTER_EXPERT_BIAS_UPDATE_METHOD:-quantile} application=${MOE_ROUTER_QUANTILE_BIAS_APPLICATION:-current_batch} warmup_steps=${MOE_ROUTER_QUANTILE_BIAS_WARMUP_STEPS:-0}
...
Allocator:     PYTORCH_CUDA_ALLOC_CONF=${PYTORCH_CUDA_ALLOC_CONF:-expandable_segments:True,garbage_collection_threshold:0.6}
...
export STREAMBP_MOE_MLP_BACKWARD_CHUNKS="${STREAMBP_MOE_MLP_BACKWARD_CHUNKS:-4}"
...
export MOE_ROUTER_PADDING_FOR_QUANTIZATION="${MOE_ROUTER_PADDING_FOR_QUANTIZATION:-1}"
...
export APPLY_ROPE_FUSION="${APPLY_ROPE_FUSION:-1}"
...
export MOE_ROUTER_EXPERT_BIAS_UPDATE_METHOD="${MOE_ROUTER_EXPERT_BIAS_UPDATE_METHOD:-quantile}"
export MOE_ROUTER_QUANTILE_BIAS_ITERS="${MOE_ROUTER_QUANTILE_BIAS_ITERS:-5}"
export MOE_ROUTER_QUANTILE_BIAS_APPLICATION="${MOE_ROUTER_QUANTILE_BIAS_APPLICATION:-current_batch}"
