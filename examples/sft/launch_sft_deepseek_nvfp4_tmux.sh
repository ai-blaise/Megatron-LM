...
StreamBP MoE:  chunk_forward=${STREAMBP_MOE_CHUNK_FORWARD:-0} mlp_chunks=${STREAMBP_MOE_MLP_CHUNKS:-4} bwd_mlp_chunks=${STREAMBP_MOE_MLP_BACKWARD_CHUNKS:-8} skip_pp=${MEGATRON_STREAMBP_SKIP_PP_RANKS-}
...
export STREAMBP_MOE_MLP_BACKWARD_CHUNKS="${STREAMBP_MOE_MLP_BACKWARD_CHUNKS:-8}"
