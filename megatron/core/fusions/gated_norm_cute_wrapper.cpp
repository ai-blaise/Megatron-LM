...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("gated_norm_cute_fwd",
        ...
        "Fused GatedNorm forward (CuTe SM100 BF16). Returns cudaError_t as "
        "int64. cudaErrorInvalidValue (1) signals SMEM-overflow / unsupported "
        "(R,N) → caller must fall back to torch.mm.");
}
